  ...
  registerForm() {
    return (
      <form role="form" onSubmit={this.submitRegister}>
        ...
        <div className="form-group">
          <div className="btn-group-justified">
            <button type="submit" className="btn btn-lg btn-green isThemeBtn">Registrarse</button>
          </div>
        </div>
        <p className="help-block">
          <span>¿Ya eres miembro de club-trueque.com? </span>
          <a
            href="#"
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title">
                {this.state.isActiveForm ? 'Verify your account' : 'Registrarse'}
              </h4>
            </div>
